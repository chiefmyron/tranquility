...
class DatabaseSeeder extends Seeder {
	...
	public function run()
	{
        ...
        if (($handle = fopen("./resources/database/seeds/referenceData/cd_locales.csv", "r")) !== FALSE) {
        ...
        if (($handle = fopen("./resources/database/seeds/referenceData/cd_timezones.csv", "r")) !== FALSE) {
            while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
        ...
        if (($handle = fopen("./resources/database/seeds/referenceData/cd_countries.csv", "r")) !== FALSE) {
            while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
