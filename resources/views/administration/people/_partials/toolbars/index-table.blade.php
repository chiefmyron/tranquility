	...
	{{ Toolbar::addLink('Delete selected people', 'toolbar-delete-multiple-people', action('Administration\PeopleController@confirmAction', ['action' => 'delete']), 'ajax multi-select', 'trash', false) }}
	{{ Toolbar::addDivider() }}
	...
	{{ Toolbar::addDivider() }}
	{{ Toolbar::addLink('Switch to detail view', 'toolbar-switch-view-detail', action('Administration\PeopleController@index', ['view' => 'detail']), 'ajax', 'user') }}
	{!! Toolbar::render() !!}