...
<div class="modal-body">
    ...
    <div class="form-group">
        ...
        {!! Form::text('tags', implode(', ', $tags), ['class' => 'form-control', 'data-custom-control' => 'tag-input', 'data-custom-control-datasource' => action('Administration\TagsController@autocomplete'), 'autofocus']) !!}	
