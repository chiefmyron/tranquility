<div class="modal-header">
    ...
    <h3 class="modal-title" id="modal-dialog-title">{{ trans('administration.address_heading_add_new_phone_number') }}</h3>
</div>
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary" id="dialog-submit">{{ trans('administration.address_heading_add_new_phone_number') }}</button>
</div>
{!! Form::close() !!}