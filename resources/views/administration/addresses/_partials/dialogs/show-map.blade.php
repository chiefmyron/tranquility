...
<div class="modal-body full-bleed">
    <iframe width="100%" height="360" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.co.uk/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q={{ $address->urlEncodedAddress() }}&amp;aq=0&amp;t=m&amp;ie=UTF8&amp;hq=&amp;hnear={{ $address->urlEncodedAddress() }}&amp;z=14&amp;iwloc=&amp;output=embed&amp;ll={{ $address->latitude }},{{ $address->longitude }}"></iframe>
</div>
